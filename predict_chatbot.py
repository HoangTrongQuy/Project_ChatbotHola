...
user_id = check_validate_User_ID('D:\FPT_University\Spring_2023\AIP391\Test\Account_Management\Account.txt', "Enter Name:")
...
while True:
    ...
    if question == 'ok' or question == 'bye':
        ...
        # chat_delay(line)
        break
    save_file_comunication('D:\FPT_University\Spring_2023\AIP391\Test\Comunication', filename,
