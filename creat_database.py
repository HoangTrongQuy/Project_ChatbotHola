...
def create_database(name, table):
    conn = sqlite3.connect(f'D:\FPT_University\Spring_2023\AIP391\Test\Database\{name}.db')
...
# create_database("List_Motel", "tro")
...
# delete_database("List_Motel","Trọng Quý","tro")
...
# delete_database2("Waiting_cf","Cân Thủy","Account")
...
# create_database_2("Waiting_cf","Minh Anh","Account")
# create_database_2("Waiting_cf","Kiều Quyên","Account")
# create_database_2("Waiting_cf","Tuấn Cường","Account")
